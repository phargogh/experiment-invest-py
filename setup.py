...
EXTENSION_LIST = ([
    Extension(
        ...
        sources=[
        'natcap/invest/scenic_quality/scenic_quality_cython_core.pyx']),
    Extension(
        name="ndr_core",
        sources=['natcap/invest/ndr/ndr_core.pyx'],
        language="c++"),
    Extension(
        name="seasonal_water_yield_core",
        sources=['natcap/invest/seasonal_water_yield/seasonal_water_yield_core.pyx'],
        language="c++"),
    ])
...
setup(
    ...
    package_dir={'natcap.invest': 'natcap/invest'},
    include_package_data=True,
    install_requires=REQUIREMENTS,
    include_dirs=[numpy.get_include()],
    setup_requires=['nose>=1.0'],
    use_scm_version={
        'write_to': 'natcap/invest/version.py',
    },
    cmdclass=CMDCLASS,
    license=LICENSE,
    zip_safe=False,
